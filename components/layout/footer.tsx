        ...
        <div className="flex flex-col items-center justify-center gap-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 mt-2">
            ...
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent side="right" className="w-full sm:max-w-lg overflow-y-auto bg-white p-6 shadow-2xl border-l">
                <SheetHeader className="pb-6 border-b">
                  <SheetTitle className="text-2xl font-bold text-slate-900 text-left">Privacy Policy</SheetTitle>
                  <p className="text-xs text-muted-foreground text-left mt-1">
                    Last updated: February 2026
                  </p>
                </SheetHeader>
                <div className="space-y-6 pt-6 text-sm text-slate-600 leading-relaxed text-left">
                  <section>
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">1. Information We Collect</h4>
                    <p>
                  ...
                  <section>
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">2. How We Use Your Information</h4>
                    <p>
                  ...
                  <section>
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">3. Data Protection and Security</h4>
                    <p>
                  ...
                  <section>
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">4. Your Rights (GDPR & Data Protection)</h4>
                    <p>
                  ...
                  <section>
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">5. Cookies and Tracking</h4>
                    <p>
                  ...
                  <section className="pb-8">
                    <h4 className="font-semibold text-slate-900 mb-2 text-base">6. Contact Us</h4>
                    <p>
