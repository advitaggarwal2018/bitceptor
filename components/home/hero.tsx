    ...
    ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-8">
          ...
          {/* LEFT */}
          <div className="flex-1 space-y-7 text-center lg:text-left animate-fade-up">
          ...
          {/* RIGHT */}
          <div className="relative w-full max-w-sm flex-shrink-0 lg:max-w-md xl:max-w-lg animate-scale-in" style={{ animationDelay: "0.15s" }}>
            <HeroIllustration />
          </div>
