          ...
          {services.map((svc, i) => {
            ...
            return (
              <a
                ...
                className="group flex-none w-72 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/60 shadow-sm dark:shadow-none transition-all duration-300 focus:outline-none cursor-pointer"
                style={{
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-9 h-9 rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-850 flex items-center justify-center text-slate-600 dark:text-slate-400 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 shadow-sm"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-24 h-[3px] rounded-full bg-slate-200 dark:bg-slate-800 relative overflow-hidden">
              <div
