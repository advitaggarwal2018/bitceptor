...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section id="ai-solutions" className="w-full py-16 md:py-24 border-t border-border bg-slate-50/50 dark:bg-slate-900/10">
      ...
      {/* About Section */}
      <section id="about" className="w-full py-16 md:py-24 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Contact Section */}
      <section id="contact" className="w-full py-16 md:py-24 border-t border-border bg-slate-50/50 dark:bg-slate-900/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
